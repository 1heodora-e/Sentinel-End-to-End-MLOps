...
def prepare_data_from_directories(data_dir, validation_split=0.2):
    ...
    print(f"Processing {len(safe_files)} safe files and {len(danger_files)} danger files...")
...
def train_model(data_dir, model_path, epochs=10, batch_size=32, validation_split=0.2, existing_model=None):
    """
